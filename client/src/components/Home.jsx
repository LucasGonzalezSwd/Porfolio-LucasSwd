    ...
    const img = "https://storage.googleapis.com/ibiza-station/perfil.jpg"; 
      ...
      return (
          ...
          <div className="flex  max-[400px]:flex-col flex-row w-4/6 h-4/6 justify-center items-center rounded-md">
                ...
                <div className="flex flex-col w-full h-full items-center max-[400px]:pl-[1.5rem] max-[400px]:p-[0rem] max-[400px]:pt-[10.8rem]  p-[2.5rem] pl-[3.5rem] justify-center">
                ...
                <div className="flex w-3/5  max-[400px]:w-full pl-[1rem]  max-[400px]:pl-0 max-[400px]:pt-[8rem] justify-start max-[400px]:justify-center  items-center text-black h-full max-[400px]:pb-[10rem] ">
