  ...
  export const Home = () => {
    ...
    const img = "https://storage.googleapis.com/ibiza-station/perfil.jpg"; 
      ...
      return (
          ...
          <div className=" flex  max-[400px]:mt-[8rem] max-[450px]:mt-[8rem] justify-center items-center  w-screen h-screen " id="home" >
        
          <div className="flex  max-[400px]:flex-col max-[450px]:flex-col  flex-row w-4/6 h-4/6 justify-center items-center rounded-md">

                <div className="flex flex-col w-full h-full items-center max-[400px]:pl-[1.5rem] max-[400px]:p-[0rem] max-[400px]:pt-[13.5rem] max-[450px]:pl-[1.5rem] max-[450px]:p-[0rem] max-[450px]:pt-[14.5rem] p-[2.5rem] pl-[3.5rem] justify-center">
