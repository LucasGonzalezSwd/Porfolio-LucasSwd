  ...
  return (
    <div className="">
      ...
      <div className=" flex justify-center w-screen mt-[1rem] mb-[1rem] ">
              <div className='flex flex-col justify-center items-center rounded-xl max-[400px]:gap-[2.8rem] gap-[1.8rem] max-[400px]:w-full w-4/5 z-10 mb-[1rem] h-full cursor-pointer' >
                
                <div className='flex w-full '>
                <p  className=' text-black text-3xl pt-[1.2rem] '>{"< Projects />"}</p>
                </div>
                <div className='flex max-[400px]:flex-col w-full gap-[1rem]  '>
                  <div className='flex   max-[400px]:w-full w-2/3 p-[0.5rem] rounded-xl shadow-lg shadow-gray-400 hover:scale-105 transition-all ease-in-out duration-500  max-[400px]:h-full h-full'>
                       <img className='' src={backimg3} alt="" />
                  </div>
                  <div className='flex flex-col  max-[400px]:w-full w-1/3 shadow-lg shadow-gray-400 rounded-xl  p-[1.8rem]'>
                      <h1 className='text-3xl  '>Calculator App</h1>
                      <p className='mt-[1rem] max-[400px]:text-ms '>
                      ...
                      <div className='flex items-end  h-full gap-[1.6rem] max-[400px]:mt-[1.5rem] pb-[1.5rem]'>
                ...
                <div className='flex max-[400px]:flex-col w-full gap-[1rem] '>
                  ...
                  <div className='flex flex-col  max-[400px]:w-full w-1/3 shadow-lg shadow-gray-400 rounded-xl  p-[1.8rem]'>
                      ...
                      <div className='flex max-[400px]:mt-[1.5rem]  items-end  h-full gap-[1.6rem] pb-[1.5rem]'>
