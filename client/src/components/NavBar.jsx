...
export const NavBar = () =>{
    ...
    const scrollToSection = (sectionId) => {
     ...
     return(
        <div className="fixed w-5/12 min-[1650px]:text-lg bg-[#000000a6] shadow-lg shadow-purple-300 h-[3.4rem] rounded-full mt-[2.2rem] max-[400px]:mt-[1.6rem]  max-[400px]:w-8/12  z-20">
