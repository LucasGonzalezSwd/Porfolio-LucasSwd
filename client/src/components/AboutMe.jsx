...
export const AboutMe = () => {
  ...
  return (
   ...
   <div className='flex max-[400px]:flex-col max-[450px]:flex-col max-[400px]:w-full max-[450px]:w-full w-4/5 gap-4 h-full  z-10  mb-4' >
               ...
               <h2 className=''> <FontAwesomeIcon icon={faCircle} size="2xs" className=' text-black'/> BarberShop Club</h2>
                ...
                <div className=' p-[2rem] shadow-lg shadow-gray-400 flex flex-col rounded-2xl max-[450px]:w-[17rem] max-[400px]:w-[17rem] w-[35rem] mb-[1rem] h-[16rem]'>
