...
export const AboutMe = () => {
  ...
  return (
   ...
   <div className='flex max-[400px]:flex-col max-[450px]:flex-col max-[400px]:w-full max-[450px]:w-full w-4/5  h-full  z-10  mb-4' >
               ...
               <div className='max-[400px]:mt-[7rem] max-[450px]:mt-[7rem] w-1/2 max-[400px]:w-full max-[450px]:w-full min-[1650px]:text-lg flex p-1 rounded text-black  gap-4  flex-wrap items-center justify-center'>
