...
export const AboutMe = () => {
  ...
  return (
   ...
   <div className='flex max-[400px]:flex-col max-[450px]:flex-col max-[400px]:w-full max-[450px]:w-full w-4/5  h-full  z-10  mb-4' >
               ...
               <div className=' w-1/2 max-[400px]:w-full max-[450px]:w-full min-[1650px]:text-lg flex p-1 rounded text-black  gap-4  flex-wrap items-center justify-center'>
                ...
                <div className='p-[1.7rem] shadow-lg shadow-gray-400 max-[1600px]:w-[15rem] w-[17rem] flex flex-col rounded-2xl h-[16rem]'>
               ...
               <h2 className=''> <FontAwesomeIcon icon={faCircle} size="2xs" className=' text-black'/> Ibiza Station</h2>
                ...
                <div className=' p-[1.5rem] shadow-lg shadow-gray-400 max-[1600px]:w-[15rem] w-[17rem] flex flex-col rounded-2xl h-[16rem]'>
               <h2 className=''> <FontAwesomeIcon icon={faCircle} size="2xs" className=' text-black'/> BarberShop Club</h2>
                ...
                <div className=' p-[2rem] shadow-lg shadow-gray-400 flex flex-col rounded-2xl max-[450px]:w-[17rem] max-[400px]:w-[17rem] max-[1600px]:w-[31rem] w-[35rem] mb-[1rem] h-[16rem]'>
